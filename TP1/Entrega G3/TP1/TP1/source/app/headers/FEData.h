...
typedef enum {
	IDDLE_ANIMATION,OPEN_SELECTED_ANIMATION, BRIGHTNESS_SELECTED_ANIMATION, USER_SELECTED_ANIMATION, CLAVE_SELECTED_ANIMATION, ADD_SELECTED_ANIMATION, DEL_SELECTED_ANIMATION
} animation_t;
